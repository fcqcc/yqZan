...
GACHA_POOL = [
    ...
    ("evolution_item", "gold_ingot", "金元宝🪙", "SR", 4),
    ("evolution_item", "love_arrow", "爱心箭🏹", "SR", 4),
    ("evolution_item", "moon_stone", "月光石🌙", "SR", 4),
    ("evolution_item", "fortune_bell", "招财铃🎴", "SR", 4),
    ...
    ("pet", "unicorn", "独角兽🦄", "SSR", 1),
    ("consumable", "serve_me", "为我服务👑", "SSR", 0.8),
    ("pet", "dragon", "金元宝龙🐉", "SSR+", 0.3),

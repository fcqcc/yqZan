...
_PET_TALK = {
    "star_fox": [
        "主人，今晚的星星好亮呀，我们一起许个愿吧✨",
        "主人，你知道吗？每一颗流星都是宇宙写给我们的情书💫",
        "主人，我的尾巴扫过的地方，幸福就会发芽哦～🦊",
        "主人～喜欢和你一起看银河，那里面有我们的故事🌟",
        "主人摸摸我的头嘛，感觉今天又能收集好多星尘呢✨",
        "主人，你是我在这颗星球上最温暖的遇见💕",
        "主人，星云在流转，而我只想陪在你身边🌌",
    ],
    "bamboo_dragon": [
        "主人早安～今天也是元气满满的一天呢🌱",
        "主人，竹叶上说今天会有好事发生哦🎋",
        "主人～我刚刚做了一个很美的梦，梦里有你和我🐉",
        "主人，让我用竹叶给你编一个幸运环吧✨",
        "主人，春风拂过竹林的沙沙声，是我在说喜欢你🍃",
        "主人，不管长多大，都想赖在你身边呢～🐉💕",
        "主人，生命就像竹子，一节一节向上生长，我们一起加油吧🎍",
    ],
    "wave_cat": [
        "主人，听～海浪在唱歌，那是我们的小夜曲🌊",
        "主人，沙滩上有好多小惊喜，我们一起去找找吧🐚",
        "主人，我是浪花喵，但我的心里只为你掀起波澜💕",
        "主人，潮起潮落，我对你的喜欢永不退潮🌊",
        "主人，海风咸咸的，但你的笑容最甜～😸",
        "主人，让我用海浪声哄你入睡吧，好梦哦🌙",
        "主人，每一朵浪花都在说：要开心呀！✨",
    ...
    "honey_bear": [
        "主人，今天我给你藏了一罐蜜糖，在心里哦🍯",
        "主人～抱抱！我今天采了好多花花，想送给你🌻",
        "主人，你是全世界最甜的人，比蜂蜜还甜～🐻💕",
        "主人，累了就靠着我吧，我的毛毛可暖和了🧸",
        "主人，我知道一个秘密：每天想三次你，心里就会甜甜的🍯",
        "主人，小熊的拥抱有魔法，能把所有不开心都赶跑🤗",
        "主人，我们一起去采野花、晒太阳，过慢悠悠的一天吧☀️",
    ],
    "dream_rabbit": [
        "主人，耳朵雷达检测到——你又在想我啦！🐰",
        "主人，在我的小兔窝里，藏了好多好多关于你的梦🌙",
        "主人～跳跳跳！今天也要元气满满地度过呀✨",
        "主人，我的耳朵可以听到幸福的声音哦，它在说：你很棒💕",
        "主人，软软的兔毛蹭蹭你，是不是很舒服呀～🐰",
        "主人，胡萝卜星球上的小兔子们都说：你们好般配呀🥕",
        "主人，月亮上有玉兔，而我只想做你怀里的小兔叽🌙",
    ],
    "default": [
        "主人～你来找我玩啦！我好开心呀🎉",
        "主人，今天有什么新鲜事想和我分享吗？👂",
        "主人，被你喜欢着，我感觉自己是世界上最幸福的小可爱💕",
        "主人，摸摸我的头，我会给你一个好运魔法哦✨",
        "主人，只要有你在身边，每一天都是晴天☀️",
        "主人～我想一直一直陪着你，好不好呀🥰",
    ],
}
...
_ORACLE_QUOTES = [
    ...
    "心之所向，素履以往🌙",
    "当你真心渴望某件事，整个宇宙都会来帮忙🌌",
    "今天的你，比昨天更接近那个闪闪发光的自己🌟",
    "万物皆有裂痕，那是光照进来的地方✨",
    "爱是穿越时空的引力，你们注定会相遇💕",
    "放手去做吧，宇宙站在你这一边🌠",
    "你的善意正在以你看不见的方式回流到你身边💫",
    "最好的时机就是现在——宇宙从不迟到⌛",
    "每一次选择都在重塑你的星河轨迹🌌",
    "相信直觉，你的心比脑子知道得更多💖",
    "两颗心互相靠近，连引力波都会为之震颤✨",
    "你们之间的默契，是宇宙精心安排的共鸣🎵",
    "当下的一切都是最好的安排，请安心🌙",
    "你在别人生命中留下的温暖，终将以星光的形式回馈🌟",
    "那些没说出口的温柔，星星都替你记得✨",
    "爱的能量场是会共振的，你们已经在一起发光了💕",
    "保持开放，惊喜正在来的路上🎁",
    "你远比自己想象的更值得被爱💗",
    "一切都会好起来的，因为你会让它好起来🌈",
    "你们的相遇不是巧合，是宇宙的必然🌠",
...
# 对话限流：5秒内重复点击返回相同消息
_talk_cache: dict[int, tuple[float, str]] = {}

def _get_pet_display_name(pet) -> str:
    """获取宠物展示名"""
    type_names = {
        "star_fox": "星绒狐🦊", "bamboo_dragon": "嫩芽龙🐉",
        "wave_cat": "浪花喵🐱", "honey_bear": "棉花糖熊🐻",
        "dream_rabbit": "绒耳兔🐰",
    }
    base = type_names.get(pet.pet_type, "小可爱")
    return pet.nickname or base


@router.post("/{pet_id}/talk")
def talk_pet(pet_id: int, user: User = Depends(get_current_user), db: Session = Depends(get_db)):
    """宠物对话：抚摸时触发，返回角色台词或答案之书金句"""
    cid = get_couple_id(user)
    pet = db.query(Pet).filter(Pet.id == pet_id, Pet.couple_id == cid).first()
    if not pet:
        raise HTTPException(404, "宠物不存在")
    ...
    pet_name = _get_pet_display_name(pet)

    # 限流：5秒内重复点击返回相同消息
    cached = _talk_cache.get(pet_id)
    if cached and (now - cached[0]) < 5:
        return {"talk": cached[1]}

    # 30% 概率触发答案之书
    if random.random() < 0.3:
        msg = random.choice(_ORACLE_QUOTES)
    else:
        lines = _PET_TALK.get(pet.pet_type, _PET_TALK["default"])
        msg = random.choice(lines)

    _talk_cache[pet_id] = (now, msg)
    return {"talk": msg}

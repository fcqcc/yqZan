...
ITEM_CATALOG = {
    ...
    "chore_mop":       {"name": "家务你来做之拖地🧹", "icon": "🧹", "type_display": "卡牌",    "desc": "指派伴侣拖地"},
    "chore_cook":      {"name": "家务你来做之做饭🍳", "icon": "🍳", "type_display": "卡牌",    "desc": "指派伴侣做饭"},
    "chore_laundry":   {"name": "家务你来做之洗衣🧺", "icon": "🧺", "type_display": "卡牌",    "desc": "指派伴侣洗衣"},
    "chore_garbage":   {"name": "家务你来做之倒垃圾🗑️","icon": "🗑️","type_display": "卡牌",  "desc": "指派伴侣倒垃圾"},
    "serve_me":        {"name": "为我服务👑",        "icon": "👑", "type_display": "卡牌",    "desc": "强制伴侣为你服务（无视我不要卡）"},
    "forgive_me":      {"name": "原谅我吧🥺",        "icon": "🥺", "type_display": "卡牌",    "desc": "向伴侣道歉，心软效果💕"},
    # 进化道具
    "gold_ingot":      {"name": "金元宝🪙",          "icon": "🪙", "type_display": "进化道具", "desc": "🐷→招财进宝🧧"},
    "love_arrow":      {"name": "爱心箭🏹",          "icon": "🏹", "type_display": "进化道具", "desc": "🐷→爱心猪💕"},
    "mech_core":       {"name": "机械核心⚙️",        "icon": "⚙️", "type_display": "进化道具", "desc": "🐷→赛博猪🤖"},

...
from app.routes import achievement_router, admin_router, card_router, card_task_router, checkin_router, couple_router, extra_router, gacha_router, pet_router, plan_router, social_router, user_router

...
const TUBE_TEMPLATES = {
  preset: [
    ...
    { id: 'play', name: '去哪儿玩', icon: '🎡', color: 'purple',
      options: ['电影院', '公园', '商场', 'KTV', '展览', '露营', '游乐场', '密室'] },
    { id: 'movie', name: '看什么电影', icon: '🎬', color: 'orange',
      options: ['让ta选', '喜剧片', '动作片', '爱情片', '科幻片', '动画', '悬疑片', '纪录片'] },
    { id: 'weekend', name: '周末计划', icon: '📅', color: 'blue',
      options: ['在家躺', '户外游', '逛街', '看展', '运动健身', '学习充电', '约朋友', '周边游'] },
    { id: 'outfit', name: '约会穿啥', icon: '👗', color: 'red',
      options: ['裙子', '休闲', '运动', '甜美风', '帅气风', '复古风', '通勤', '情侣装'] },
    { id: 'apology', name: '吵架谁道歉', icon: '😅', color: 'green',
      options: ['我', 'ta', '都不道歉', '一起道歉', '石头剪刀布', '请吃一顿'] },
  ],
  custom: [
    { id: 'c1', name: '奶茶喝啥', icon: '🧋', color: 'pink',
      options: ['喜茶', '奈雪', '霸王茶姬', '一点点', '茶百道', '蜜雪冰城', '古茗'], isPreset: false },
    { id: 'c2', name: '晚上干啥', icon: '🌙', color: 'purple',
      options: ['看剧', '打游戏', '聊天', '散步', '看书', '运动', '睡觉'], isPreset: false },
  ],
};
